...
mixin _$FormStore on _FormStore, Store {
  ...
  String toString() {
    final string =
        'userEmail: ${userEmail.toString()},password: ${password.toString()},confirmPassword: ${confirmPassword.toString()},success: ${success.toString()},loading: ${loading.toString()},canLogin: ${canLogin.toString()},canRegister: ${canRegister.toString()},canForgetPassword: ${canForgetPassword.toString()}';
    return '{$string}';
  }
}
...
mixin _$FormErrorStore on _FormErrorStore, Store {
  ...
  String toString() {
    final string =
        'userEmail: ${userEmail.toString()},password: ${password.toString()},confirmPassword: ${confirmPassword.toString()},hasErrorsInLogin: ${hasErrorsInLogin.toString()},hasErrorsInRegister: ${hasErrorsInRegister.toString()},hasErrorInForgotPassword: ${hasErrorInForgotPassword.toString()}';
    return '{$string}';
  }
}
